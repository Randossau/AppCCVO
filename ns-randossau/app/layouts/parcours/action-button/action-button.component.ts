...
export class ActionButtonComponent {
	...
	@ViewChild("lineTop", {static: true}) _lineTopRef: ElementRef;
	@ViewChild("lineCenter", {static: true}) _lineCenterRef: ElementRef;
	@ViewChild("lineBottom", {static: true}) _lineBottomRef: ElementRef;
